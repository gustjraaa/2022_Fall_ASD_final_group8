...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):# ASD final project : changing relu to silu
...
class ResNet(nn.Module):# ASD final project : adding convolution layer, changing output stage layer and stride
    def __init__(self, block, num_blocks, num_classes=10):# changing output layer
